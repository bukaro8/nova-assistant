  ...
  const response = await fetch(OPENAI_RESPONSES_URL, {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "Treat groceries, housing bills, and normal transport as baseline spending by default.",
        "Do not over-analyse groceries unless the metrics flag them as unusually high.",
        "Prioritise discretionary behavioural spending: takeaway, coffee snacks, entertainment, shopping, subscriptions, and personal care.",
        "Avoid generic advice such as spreading grocery shops more evenly.",
        "If spending is mostly essentials, say so honestly and avoid inventing overspending.",
